(() => {
  ...
  var clamp = function(dictOrd) {
    return function(low2) {
      return function(hi) {
        return function(x) {
          return min(dictOrd)(hi)(max(dictOrd)(low2)(x));
        };
      };
    };
  };
    ...
    return function(green$prime) {
      return function(blue$prime) {
        return function(alpha) {
          var red = clamp(ordInt)(0)(255)(red$prime);
          var r = toNumber(red) / 255;
          var green = clamp(ordInt)(0)(255)(green$prime);
          var g = toNumber(green) / 255;
          var blue = clamp(ordInt)(0)(255)(blue$prime);
          var maxChroma = max(ordInt)(max(ordInt)(red)(green))(blue);
          var minChroma = min(ordInt)(min(ordInt)(red)(green))(blue);
  ...
  var valColor = {
    value: /* @__PURE__ */ function() {
      var $107 = fromString(isStringValue);
      return function($108) {
        return $107(cssStringHSLA($108));
      };
    }()
  };
  var valNumber = {
  ...
  var valTuple = function(dictVal) {
    return function(dictVal1) {
      return {
        value: function(v) {
          return append(semigroupValue)(value(dictVal)(v.value0))(append(semigroupValue)(fromString(isStringValue)(" "))(value(dictVal1)(v.value1)));
        }
      };
    };
  };
  ...
  var isStringSize = {
    fromString: /* @__PURE__ */ function() {
      var $36 = fromString(isStringValue);
      return function($37) {
        return BasicSize.create($36($37));
      };
    }()
  };
  var autoSize = {
    auto: /* @__PURE__ */ fromString(isStringSize)("auto")
  };
  ...
  var backgroundColor$prime = {
    background: /* @__PURE__ */ key(valColor)(/* @__PURE__ */ fromString(isStringKey)("background")),
    Val0: function() {
      return valColor;
    }
  };
  ...
  var display = /* @__PURE__ */ key(valDisplay)(/* @__PURE__ */ fromString(isStringKey)("display"));
  var block = /* @__PURE__ */ fromString(isStringValue)("block");
  ...
  var padding = function(a2) {
    return function(b2) {
      return function(c) {
        return function(d) {
          return key(valTuple(valTuple(valSize)(valSize))(valTuple(valSize)(valSize)))(fromString(isStringKey)("padding"))(new Tuple(new Tuple(a2, b2), new Tuple(c, d)));
        };
      };
    };
  };
  var marginTop = /* @__PURE__ */ key(valSize)(/* @__PURE__ */ fromString(isStringKey)("margin-top"));
  var marginRight = /* @__PURE__ */ key(valSize)(/* @__PURE__ */ fromString(isStringKey)("margin-right"));
  var marginLeft = /* @__PURE__ */ key(valSize)(/* @__PURE__ */ fromString(isStringKey)("margin-left"));
  var marginBottom = /* @__PURE__ */ key(valSize)(/* @__PURE__ */ fromString(isStringKey)("margin-bottom"));
  var margin = function(a2) {
    return function(b2) {
      return function(c) {
        return function(d) {
          return key(valTuple(valTuple(valSize)(valSize))(valTuple(valSize)(valSize)))(fromString(isStringKey)("margin"))(new Tuple(new Tuple(a2, b2), new Tuple(c, d)));
        };
      };
    };
  };
            ...
            return function($copy_count) {
              ...
              function $tco_loop(dictApplicative, fStack, valStack, nat, func, count) {
                ...
                if (func instanceof Ap) {
                  ...
                  $tco_var_valStack = cons4(func.value1)(valStack);
                  $tco_var_nat = nat;
  ...
  var main = /* @__PURE__ */ element3("main");
  ...
  var width = /* @__PURE__ */ prop2(isPropInt)("width");
  var id2 = /* @__PURE__ */ prop2(isPropString)("id");
  var height = /* @__PURE__ */ prop2(isPropInt)("height");
  ...
  var style2 = /* @__PURE__ */ function() {
    var toString = function() {
      var $4 = joinWith("; ");
      var $5 = foldMap2(monoidArray)(function(key2) {
        return function(val) {
          return [key2 + (": " + val)];
        };
      });
    ...
    var rules = function(rs) {
      var properties = bind(bindArray)(mapMaybe(property)(rs))(function($7) {
        return rights(collect2($7));
      });
      return fromFoldable3(foldableArray)(properties);
    };
    var $8 = attr2("style");
    return function($9) {
      return $8(toString(rules(runS($9))));
    };
  }();

  // output/Breakout/index.js
  ...
  var draw = function(canvas2) {
    return function __do2() {
      ...
      setStrokeStyle(ctx)("rgba(0, 0, 255, 0.5)")();
      stroke(ctx)();
  ...
  var handleAction = function(dictMonadAff) {
    return function(v) {
      return bind(bindHalogenM)(liftEffect(monadEffectHalogenM(dictMonadAff.MonadEffect0()))(getCanvasElementById(canvasId)))(function(maybeCanvas) {
        return liftEffect(monadEffectHalogenM(dictMonadAff.MonadEffect0()))(function() {
          ...
          ;
          throw new Error("Failed pattern match at Breakout (line 69, column 9 - line 71, column 37): " + [maybeCanvas.constructor.name]);
        }());
      });
    };
  };
  var render2 = function(v) {
    return main([style2(discard(discardUnit)(bindStyleM)(margin(px(0))(px(0))(px(0))(px(0)))(function() {
      return padding(px(0))(px(0))(px(0))(px(0));
    }))])([canvas([style2(discard(discardUnit)(bindStyleM)(background(backgroundColor$prime)(rgb(238)(238)(238)))(function() {
      return discard(discardUnit)(bindStyleM)(display(block))(function() {
        return discard(discardUnit)(bindStyleM)(marginTop(px(0)))(function() {
          return discard(discardUnit)(bindStyleM)(marginRight(auto(autoSize)))(function() {
            return discard(discardUnit)(bindStyleM)(marginBottom(px(0)))(function() {
              return marginLeft(auto(autoSize));
            });
          });
        });
      });
    })), id2(canvasId), width(480), height(320)])]);
  };
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
    return runUI2(component(monadAffAff))(unit)(body2);
  }));
